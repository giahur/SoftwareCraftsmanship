...
public record Indexes(int row, int column) implements Comparable<Indexes> {
    ...
    public static final Comparator<Indexes> byRows = new Comparator<Indexes>() {
        @Override
        public int compare(Indexes index1, Indexes index2) {
    ...
    public static final Comparator<Indexes> byColumns = new Comparator<Indexes>() {
        @Override
        public int compare(Indexes index1, Indexes index2) {
